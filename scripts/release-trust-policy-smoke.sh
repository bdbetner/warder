...
require_text "$ROOT_DIR/docs/release-trust.md" "Package-manager signatures are not included in current public beta releases."
...
"$ROOT_DIR/scripts/write-release-notes.sh" v1.0.0-beta.1 "$fixture_dir" "$notes_file"
...
require_text "$notes_file" "What Changed Since Alpha"
